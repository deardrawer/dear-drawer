                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        updateNestedField('groom.lastName', e.target.value)
                        updateNestedField('groom.name', e.target.value + (invitation.groom.firstName || ''))
                      }}
                      placeholder="김"
                    />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        updateNestedField('groom.firstName', e.target.value)
                        updateNestedField('groom.name', (invitation.groom.lastName || '') + e.target.value)
                      }}
                      placeholder="철수"
                    />
                  </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        updateNestedField('bride.lastName', e.target.value)
                        updateNestedField('bride.name', e.target.value + (invitation.bride.firstName || ''))
                      }}
                      placeholder="이"
                    />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        updateNestedField('bride.firstName', e.target.value)
                        updateNestedField('bride.name', (invitation.bride.lastName || '') + e.target.value)
                      }}
                      placeholder="영희"
                    />
                  </div>
