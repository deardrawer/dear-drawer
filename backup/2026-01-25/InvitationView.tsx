...
function createDefaultContent(invitation: Invitation): InvitationContent {
  return {
    groom: { name: invitation.groom_name || '', lastName: '', firstName: '', nameEn: '', phone: '', father: { name: '', phone: '', deceased: false, bank: { bank: '', account: '', holder: '', enabled: false } }, mother: { name: '', phone: '', deceased: false, bank: { bank: '', account: '', holder: '', enabled: false } }, bank: { bank: '', account: '', holder: '', enabled: false }, profile: { images: [], imageSettings: [], aboutLabel: 'ABOUT GROOM', subtitle: '', intro: '', tag: '' } },
    bride: { name: invitation.bride_name || '', lastName: '', firstName: '', nameEn: '', phone: '', father: { name: '', phone: '', deceased: false, bank: { bank: '', account: '', holder: '', enabled: false } }, mother: { name: '', phone: '', deceased: false, bank: { bank: '', account: '', holder: '', enabled: false } }, bank: { bank: '', account: '', holder: '', enabled: false }, profile: { images: [], imageSettings: [], aboutLabel: 'ABOUT BRIDE', subtitle: '', intro: '', tag: '' } },
