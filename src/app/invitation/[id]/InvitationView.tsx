...
const colorThemes: Record<ColorTheme, ColorConfig> = {
  ...
  'modern-black': { primary: '#111111', secondary: '#555555', accent: '#111111', background: '#FFFFFF', sectionBg: '#D5D8DC', cardBg: '#FFFFFF', divider: '#CCCCCC', text: '#2a2a2a', gray: '#444444' },
  ...
  'custom': { primary: '#C41050', secondary: '#C41050', accent: '#C41050', background: '#FFFFFF', sectionBg: '#D5D8DC', cardBg: '#FFFFFF', divider: '#E0E0E0', text: '#2a2a2a', gray: '#444444' },
    ...
    >
      ...
      <GuestFloatingButton
        ...
        invitation={{
          ...
          rsvpPhoneOption: displayData.rsvpPhoneOption,
          rsvpSideDetail: displayData.rsvpSideDetail,
          rsvpSideDetailOptions: displayData.rsvpSideDetailOptions,
          rsvpMessagePlaceholder: displayData.rsvpMessagePlaceholder,
          invitationId: invitation.id,
          groomName,
          brideName,
          weddingDate: displayData.wedding?.date,
      ...
      {sectionVisibility.ourStory && invitation.relationship?.stories?.some(s => s.title || s.desc) && (
        <>
          ...
          <section className="anim-section px-7 py-10 text-center" style={{ background: themeColors.sectionBg }}>
            <p className="anim-paragraph text-sm leading-relaxed whitespace-pre-line" style={{ fontFamily: fonts.displayKr, color: themeColors.text }}>
