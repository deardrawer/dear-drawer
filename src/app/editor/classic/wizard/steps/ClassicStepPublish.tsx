...
export default function ClassicStepPublish({ data, invitationId, slug, onSave, onSlugChange }: Props) {
  ...
  const handleKakaoShare = () => {
    ...
    if (typeof window !== 'undefined' && kakaoWindow.Kakao?.Share && kakaoWindow.Kakao.isInitialized?.()) {
      ...
      const coverImage = rawImage || classicGalleryUrl(data.gallery?.images?.[0]) || undefined
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      {/* 도움말 */}
      <div className="rounded-lg border border-gray-200 p-4 bg-gray-50/50 text-sm text-gray-600 space-y-2">
