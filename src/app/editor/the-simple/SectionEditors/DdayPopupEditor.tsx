...
import type { DdayPopupData, DdayPopupPage, DdayPopupLink, ImageWithSettings, TheSimpleImageSettings } from '../page'
...
export default function DdayPopupEditor({ value, weddingDate, onChange }: DdayPopupEditorProps) {
