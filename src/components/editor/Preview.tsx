...
function RecordPreviewWrapper({ invitation, skipIntro }: { invitation: InvitationContent; skipIntro: boolean }) {
  const content = useMemo(() => ({
    ...
    customBaseColor: (invitation as any).customBaseColor,
    ...
    giftNotice: invitation.giftNotice,
    greetingTitle: invitation.greetingTitle,
    journeyTitle: invitation.journeyTitle,
    ...
    cardAccentColor: (invitation as any).cardAccentColor,
...
function InvitationPreviewWrapper({ invitation, skipIntro, onIntroScreenChange }: { invitation: InvitationContent; skipIntro: boolean; onIntroScreenChange?: (screen: 'cover' | 'invitation') => void }) {
  const content = useMemo(() => ({
    ...
    sectionAccentColor: (invitation as any).sectionAccentColor,
    magazineBoxContrastMap: (invitation as any).magazineBoxContrastMap,
