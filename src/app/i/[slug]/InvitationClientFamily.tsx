...
const globalStyles = `
  ...
  .full-height-divider-bg {
    ...
    height: 100%;
    z-index: 0;
    /* 이미지 크롭은 CroppedImageDiv 컴포넌트로 제어 */
  }
          ...
          <div className="grid grid-cols-2 gap-2">
            {visibleImages.map((img: string, i: number) => {
              ...
              return (
                <div
                  key={i}
                  className={`relative overflow-hidden cursor-pointer hover:scale-[1.02] transition-transform ${isLastOdd ? 'col-span-2 aspect-square' : 'aspect-square'}`}
                  style={{
                    opacity: show ? 1 : 0,
      ...
      {buttonText && buttonUrl && (
        <div>
          <button
            ...
            className="mt-4 w-full px-5 py-3 typo-caption transition-all hover:opacity-80"
            style={{
            ...
            <div className="mobile-frame-content">
              <WatermarkOverlay isPaid={isPaid || isPreview} className="relative w-full min-h-screen">
                ...
                >
                  ...
                  {/* Top-level Music Toggle for intro/invitation auto-play */}
                  {(invitation.bgm?.startPage === 'intro' || invitation.bgm?.startPage === 'invitation') && invitation.bgm?.enabled && !!invitation.bgm?.url && (
                    <MusicToggle
                      audioRef={audioRef}
