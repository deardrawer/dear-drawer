...
interface InvitationClientPageProps {
  ...
  initialGuestInfo?: GuestInfo | null
}

export default function InvitationClientPage({ initialInvitation, initialGuestInfo }: InvitationClientPageProps) {
  ...
  const [guestInfo, setGuestInfo] = useState<GuestInfo | null>(initialGuestInfo || null)
  const [isLoading, setIsLoading] = useState(!initialInvitation)
  const [error, setError] = useState<string | null>(null)

  useEffect(() => {
    // 이미 초기 데이터가 있으면 fetch 하지 않음
    ...
    fetchData()
  }, [inviteId, guestId, initialInvitation])
