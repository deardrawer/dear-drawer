...
const faqItems = [
  ...
  {
    question: '예식이 끝나면 청첩장은 어떻게 되나요?',
    answer: `• 결제 완료된 청첩장: 예식일로부터 30일 후 공개(청첩장 링크)만 종료됩니다. 방명록·하객이 보내준 사진·메시지 등 기록은 삭제되지 않고 POST DRAWER에 계속 보관됩니다.\n• 미결제 청첩장: 생성일로부터 7일 후 자동 삭제됩니다.\n\n내 청첩장 목록에서 남은 기간을 확인하실 수 있습니다.`,
  },
  {
