      ...
      <section className="space-y-4">
        ...
        <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
          ...
          <p className="text-xs text-amber-700 mt-1.5">
            바로 안 바뀌면 <a href="https://developers.kakao.com/tool/debugger/sharing" target="_blank" rel="noopener noreferrer" className="underline font-medium">카카오 공유 디버거</a>에서 청첩장 링크를 입력하고 <strong>캐시 초기화</strong>를 눌러주세요.
          </p>
        </div>
