...
import { Users, Copy, Check, Eye, Mail, Heart, MapPin, Clock, ImagePlus, Bus, Plus, X, Upload, Palette, FileText, Settings, Music, Share2, CreditCard, Play, Pause } from 'lucide-react'
...
export default function ParentsEditPanel({ data, updateData, updateNestedData, invitationId, selectedGuest, onSelectGuest }: ParentsEditPanelProps) {
  // 게스트 관리 상태
